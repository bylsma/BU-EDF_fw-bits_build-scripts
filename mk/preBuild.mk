...
clean_prebuild:
	...
	@rm -f $(SLAVE_DTSI_PATH)/config*.yaml

#################################################################################
# generate prebuilds for FPGA builds in config
#################################################################################
define PREBUILD_template =
 prebuild_$(1):  $(SLAVE_DTSI_PATH)/config_$(1).yaml $(ADDRESS_TABLE_CREATION_PATH)/config_$(1).yaml
endef
...
$(SLAVE_DTSI_PATH)/config_%.yaml $(ADDRESS_TABLE_CREATION_PATH)/config_%.yaml : $(SLAVE_DEF_FILE_BASE)/%/config.yaml
