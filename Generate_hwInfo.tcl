...
#create hwdef file
write_hwdef -file ${apollo_root_path}/${hw_dir}/${build_name}/top.hwdef -force

if { [expr [package vcompare [clean_version] 2019.2 ] < 0] } {
    # create the 
    write_sysdef -hwdef ${apollo_root_path}/${hw_dir}/${build_name}/top.hwdef -bit ${apollo_root_path}/bit/top.bit -file ${apollo_root_path}/${hw_dir}/${build_name}/top.hdf -force
} else { 
    # create the hwdef file for old builds
    write_sysdef -hwdef ${apollo_root_path}/${hw_dir}/${build_name}/top.hwdef -bit ${apollo_root_path}/bit/top.bit -file ${apollo_root_path}/${hw_dir}/${build_name}/top -force

    #needed for next line since Xilinx is dumb
    open_checkpoint $outputDir/post_route.dcp
    #build Xilinx's new kind of filee....
    write_hw_platform -fixed -minimal -file ${apollo_root_path}/${hw_dir}/${build_name}/top.xsa -force
}
